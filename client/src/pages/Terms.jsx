  ...
  return (
    <main className="page--legal">
      <div className="legal-card">
        ...
        <p>These Terms are governed by the laws of England & Wales (update if different for your business).</p>

        <h2 className="legal-section-title">10. Contact</h2>
        <p>
          Questions? Email <a className="legal-link" href="mailto:legal@goalcrumbs.com">legal@goalcrumbs.com</a>.
        </p>

        <p style={{ marginTop: '2rem' }}>
          See our <Link to="/privacy" className="legal-link">Privacy Policy</Link>.
        </p>
      </div>
    </main>
  );
